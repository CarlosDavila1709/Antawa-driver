package store.antawa.shared.infrastructure.bus.query;
...
import store.antawa.shared.domain.bus.query.QueryNotRegisteredError;
...
public final class QueryHandlersInformation {
    ...
    public QueryHandlersInformation() {
        Reflections                        reflections = new Reflections("store.antawa");
