...
@Configuration
public class CustomerMySqlEventBusConfiguration {

	private final SessionFactory sessionFactory;
	private final DomainEventsInformation domainEventsInformation;
	private final SpringApplicationEventBus bus;
	
	public CustomerMySqlEventBusConfiguration(
			@Qualifier("customer-session_factory") SessionFactory sessionFactory,
