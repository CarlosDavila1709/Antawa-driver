...
public final class DriversPutController extends ApiController {
    ...
    public ResponseEntity<String> index(
    	...
    	dispatch(new CreateDriverCommand(id, request.names(), 
    			request.lastName(), 
    			request.phoneMobile(), 
    			request.email(), 
    			request.password(), 
	...
	public HashMap<Class<? extends DomainError>, HttpStatus> errorMapping() {
		return new HashMap<Class<? extends DomainError>, HttpStatus>() {
			private static final long serialVersionUID = 1069010185812938115L;
